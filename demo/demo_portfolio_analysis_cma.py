...
test_data_1 = test_data_1[['emrwd', 'Msmvttl', 'asset_growth_rate', 'Date_merge', 'Mnshrtrd', 'Mnvaltrd']].dropna()
...
# %% build AR model
ar = sm.tsa.arima.ARIMA(fac_mom, order=([5,10], 0, 0), trend='n')
res = ar.fit()
print(res.summary())
...
ar_resid = sm.tsa.arima.ARIMA(model.resid, order=[[5,10],0,0], trend='n')
